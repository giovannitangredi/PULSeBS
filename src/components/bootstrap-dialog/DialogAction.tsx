...
export default class DialogAction {
   ...
   */
  constructor(
    label: DialogActionLabel | null | undefined,
    func: DialogActionCallback | null | undefined,
    className: string | null | undefined,
    key: DialogActionKey | null | undefined
  ) {
    this.label = label || Dialog.options.defaultOkLabel;
    this._func = func;
    this.className =
      className ||
      Dialog.options.defaultButtonClassName ||
      Dialog.DEFAULT_OPTIONS.defaultButtonClassName;
    this.key = key;
  }
