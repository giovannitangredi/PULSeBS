/*
 * react-bootstrap-dialog: https://github.com/akiroom/react-bootstrap-dialog
 * Copyright (c) 2016 akiroom <akiyama@akiroom.com>
 */
...
export default class Dialog extends React.Component<Props, State> {
  ...
  static Action = (
    label?: DialogActionLabel | null,
    func?: DialogActionCallback | null,
    className?: string | null,
    key?: DialogActionKey | null
  ) => new DialogAction(label, func, className, key);
  ...
  static OKAction = (func?: DialogActionCallback | null) =>
    new DialogAction(
  ...
  static CancelAction = (func?: DialogActionCallback | null) =>
    new DialogAction(
  ...
  static PasswordPrompt = (options: DialogPromptOptions) =>
    new PasswordPrompt(options);
  ...
  public show(options: DialogOptions = {}) {
    ...
    // Setup key binds
    newOptions.actions &&
      newOptions.actions.forEach((action) => {
        if (action.key) {
    ...
    this.setState(
      Object.assign({}, Dialog.initialState(), newOptions, { showModal: true })
    );
  }
