...
const managerCredentials = {
  ...
  const Student1Tuple = { // in the lecture with the student corona +
    id: "1",
    name: "Ambra",
    surname: "Ferri",
  ...
  const Student3Tuple = { // in the lecture with the student corona +
    id: "3",
    name: "Gianfranco",
    surname: "Trentini",
    password_hash: "$2b$10$A9KmnEEAF6fOvKqpUYbxk.1Ye6WLHUMFgN7XCSO/VF5z4sspJW1o.",
  ...
  const StudentCoronaPlusTuple = {  // Corona test +
    id: "4",
    name: "Maria",
    surname: "Pugliesi",
    password_hash: "$2b$10$A9KmnEEAF6fOvKqpUYbxk.1Ye6WLHUMFgN7XCSO/VF5z4sspJW1o.",
...
const courseStudent3Tuple = {
  ...
  const lectureTuple = { // lecture with infected student
    id: 1,
